> 원본: [design-postgis-tables](https://github.com/timescale/pg-aiguide/tree/main/skills/design-postgis-tables)
> 라이선스: Apache-2.0
> 호환성: Requires PostgreSQL 15+ with the PostGIS extension
