> 원본: [migrate-postgres-tables-to-hypertables](https://github.com/timescale/pg-aiguide/tree/main/skills/migrate-postgres-tables-to-hypertables)
> 라이선스: Apache-2.0
> 호환성: Requires PostgreSQL 15+ with TimescaleDB
