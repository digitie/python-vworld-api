...
> 원본: [pgvector-semantic-search](https://github.com/timescale/pg-aiguide/tree/main/skills/pgvector-semantic-search)
> 라이선스: Apache-2.0
> 호환성: Requires PostgreSQL 15+ with the pgvector extension
