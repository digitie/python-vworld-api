...
> 원본: [postgres-hybrid-text-search](https://github.com/timescale/pg-aiguide/tree/main/skills/postgres-hybrid-text-search)
> 라이선스: Apache-2.0
> 호환성: Requires PostgreSQL 15+ with pgvector and pg_textsearch extensions
